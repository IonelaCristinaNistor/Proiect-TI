<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Stergere.aspx.cs" Inherits="Proiect_TI_1.Stergere" %>
...
<asp:Content ID="Stergere" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container text-center">
        ...
        <div class="text-center">
            <asp:GridView ID="GridView1" runat="server" OnRowCommand="GridView1_RowCommand1" AutoGenerateColumns="False" CssClass="table table-bordered" Style="margin: auto;" DataKeyNames="nr_crt" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                <Columns>
