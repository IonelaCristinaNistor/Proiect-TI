...
namespace Proiect_TI_1
{
    public partial class StatPlata : System.Web.UI.Page
    {
        ...
        private void BindGridView()
        {
            ...
            string query = "SELECT nr_crt, nume, prenume, functie, salar_baza, spor, premii_brute, total_brut, retineri, virat_card, imagine FROM proiect_ti.gestiune";
            ...
            using (MySqlConnection conn = new MySqlConnection(connectionString))
            {
                using (MySqlCommand cmd = new MySqlCommand(query, conn))
                {
                    using (MySqlDataAdapter sda = new MySqlDataAdapter())
                    {
                        ...
                        Label1.Text += totalSalarBaza.ToString() + " RON";
                    }
                }
            }
        }
        ...
        protected void btnPrintare_Click(object sender, EventArgs e)
        {
