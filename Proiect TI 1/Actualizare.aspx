<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Actualizare.aspx.cs" Inherits="Proiect_TI_1.Actualizare" %>
...
<asp:Content ID="Actualizare" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container text-center">
        ...
        <div class="row mt-4">
            ...
            <div class="col-md-4">
                <asp:TextBox ID="TextBoxSearch" runat="server" CssClass="form-control" placeholder="Caută..." OnTextChanged="TextBoxSearch_TextChanged"></asp:TextBox>
            </div>
            <div class="col-md-4">
        ...
        <div class="text-center">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered" Style="margin: auto;" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                <Columns>
